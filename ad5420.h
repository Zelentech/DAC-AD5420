...
/**
 * \brief Shorthand macro for a 10 us delay required by write to control register of DAC
 */
...
/**
 * \brief Totally portable function that initialize discrete in-out pins of uC
 */
 ...
 * 
 * Realization cycle with 1 byte via SPI interface. Bit order is from MSB to LSB.
 *
 ...
 *
 * Please set this bit before or during changing #AD5420_OUTEN bit
 */
...
/**
 * \brief This type is specifically defined
 *
 * Almost all transmissions between DAC and uC are 24-bit long
 */
...
class DAC_AD5420 {
    public:
        DAC_AD5420(const uint8_t latchPin_, const uint8_t clearPin_, const uint8_t faultPin_);
        void begin();
         ...
         *
         * \return Returns 8-bit int, last 3 bits of which is used as status flags
         * 
         * To work with them:
         *
         * \c AD5420_IOUT_FAULT, \c AD5420_SR_ACTIVE, \c AD5420_OVRHEAT_FAULT
         * macros are provided
         */
